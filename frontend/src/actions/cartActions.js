...
import { CART_ADD_ITEM, CART_REMOVE_ITEM, DECREMENT, GET_TOTAL, INCREMENT, SAVE_TO_CART } from "../constants/cartConstants";
...
export const saveToCart = (cartItems) => (dispatch, getState) => {
    dispatch({
        type: SAVE_TO_CART,
        payload: cartItems
    });
